...
// function JobSearch() {
//     return (<div className="flex justify-around mt-8">
//         <div className="flex items-center gap-6 border-r-2 border-[#EAEAEA] p-4">
...
//         <div className="flex items-center gap-2 p-4 border-r-2 border-[#EAEAEA]">
//             <i className="fa-solid fa-briefcase text-gray-500"></i>
//             <select className="text-[#7F7F7F]">
//                 <option>Job Type</option>
//                 <option>Full-time</option>
//                 <option>Part-time</option>
//                 <option>Contract</option>
...
//             <div>
//                 <span className="text-[#7F7F7F]">Salary Per Month</span>
//                 <span className="text-[#7F7F7F]">₹50k - ₹80k</span>
//             </div>
//             <input type="range" className="cursor-pointer w-full h-[2px]  rounded-lg"  />
//         </div>

    ...
    <>
      <nav className="w-[890px] h-[80px] mx-auto rounded-[122px] border border-[#FCFCFC] flex items-center px-6 justify-between bg-white"
        ...
        <button
          ...
          onClick={() => setShowCreateJob(true)} // Show CreateJob on click
        >
          Create Jobs
        </button>
      </nav>
...
// const Navbar = () => {
//   return (
//     <nav className="w-[890px] h-[80px] mx-auto rounded-[122px] border border-[#FCFCFC] flex items-center px-6 justify-between bg-white"style={{
...
//       <button className="w-[123px] h-[38px] rounded-[30px] px-2 py-2 text-[16px] text-white cursor-pointer"
//         style={{background: "linear-gradient(180deg, #A128FF 0%, #6100AD 113.79%)"}}>Create Jobs</button>
//     </nav>
//   );
// };
